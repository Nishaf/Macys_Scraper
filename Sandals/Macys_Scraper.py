...
class Macys_Scraper:
    def __init__(self):
        self.urls = [
            "https://www.macys.com/shop/shoes/sandals/Brand,Women_shoe_size_t/Calvin%20Klein%7CCOACH%7Ckate%20spade%20new%20york%7CLauren%20Ralph%20Lauren%7CMichael%20Kors%7CALDO%7CCole%20Haan%7CG%20by%20GUESS%7CGUESS,6%7C6.5%7C7%7C7.5%7C8%7C8.5%7C9?id=17570",
        ]
    ...
    def refine_links_collection(self):
        ...
        link_col = db['sandals_product_links']
        item_col = db['sandals']
    ...
    def save_product_links(self):
        ...
        for item in self.driver.find_elements_by_xpath("//ul[@class='items large-block-grid-3']/li/div/div/a"):
            if db.sandals_product_links.find({"url": item.get_attribute('href')}).count() ==  0:
                print(item.get_attribute('href'))
                db.sandals_product_links.insert({"url": item.get_attribute('href')})
        mongo.close()
