from Sandals.Macys_Scraper import Macys_Scraper
from pymongo import MongoClient
from pyvirtualdisplay import Display
from selenium import webdriver
from Sandals.Product_Scraper import ProductsScraper


def check_all_links_visited():
    mongo = MongoClient()
    database = mongo['Macys_Scraper']
    link_collection = database['sandals_product_links']
    item_collection = database['sandals']
