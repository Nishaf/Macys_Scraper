from Jackets_and_Coats.Macys_Scraper import Macys_Scraper
from pymongo import MongoClient
from pyvirtualdisplay import Display
from selenium import webdriver
from Jackets_and_Coats.Product_Scraper import ProductsScraper


def check_all_links_visited():
    mongo = MongoClient()
    database = mongo['Macys_Scraper']
    link_collection = database['jackets_product_links']
    item_collection = database['jackets']
